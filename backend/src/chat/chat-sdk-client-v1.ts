/**
 * Chat SDK Client V1 (Legacy)
 *
 * query()-based implementation preserved as fallback.
 * Use CHAT_SESSION_MODE=v1 to activate.
 */
 ...
 */
export class ChatSDKClientV1 extends ClaudeSDKBase implements IChatExecutor {
  async execute(
    message: string,
