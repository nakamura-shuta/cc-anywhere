...
describe("SchedulerService", () => {
  ...
  describe("createSchedule", () => {
    it("should create a cron schedule", () => {
      ...
      const created = scheduler.createSchedule(schedule);
    ...
    it("should create a one-time delayed schedule", () => {
    ...
    it("should validate cron expression", () => {
      ...
      expect(() => scheduler.createSchedule(schedule)).toThrow("Invalid cron expression");
    });
  });
  ...
  describe("getSchedule", () => {
    ...
    it("should return undefined for non-existent id", () => {
      const found = scheduler.getSchedule("non-existent");
  ...
  describe("listSchedules", () => {
    it("should return all schedules with pagination", () => {
      ...
      const page1 = scheduler.listSchedules({ limit: 10, offset: 0 });
      expect(page1.schedules).toHaveLength(10);
      expect(page1.total).toBe(15);

      const page2 = scheduler.listSchedules({ limit: 10, offset: 10 });
    ...
    it("should filter by status", () => {
      ...
      const activeOnly = scheduler.listSchedules({ status: "active" });
  ...
  describe("getHistory", () => {
    it.skip("should return execution history", async () => {
      ...
      const history = scheduler.getHistory(schedule.id);
