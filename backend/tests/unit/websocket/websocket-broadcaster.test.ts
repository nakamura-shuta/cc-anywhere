...
describe("WebSocketBroadcaster", () => {
  ...
  describe("legacy methods", () => {
    it("should support broadcastTaskUpdate", () => {
      const payload = { taskId: "task-123", status: "running" };
      broadcaster.legacy.broadcastTaskUpdate(payload);
    ...
    it("should support broadcastTaskLog", () => {
      const payload = { taskId: "task-123", log: "Test log", level: "info" };
      broadcaster.legacy.broadcastTaskLog(payload);
    ...
    it("should support broadcastTaskGroupProgress", () => {
      const payload = { groupId: "group-456", progress: 50 };
      broadcaster.legacy.broadcastTaskGroupProgress(payload);
    ...
    it("should support broadcastScheduleUpdate", () => {
      const payload = { scheduleId: "schedule-789", status: "active" };
      broadcaster.legacy.broadcastScheduleUpdate(payload);
